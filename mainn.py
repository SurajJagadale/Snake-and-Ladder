...
def roll_dices():
    ...
    #    print((player_turn % int(no_players) +1)," ",count)
        ...
        #    print("win")
            if((player_turn % int(no_players) +1)==1): mb.showwarning(title = "Game Over", message = "Player 1 had win!!")
            if((player_turn % int(no_players) +1)==2): mb.showwarning(title = "Game Over", message = "Player 2 had win!!")
            if((player_turn % int(no_players) +1)==3): mb.showwarning(title = "Game Over", message = "Player 3 had win!!")
            if((player_turn % int(no_players) +1)==4): mb.showwarning(title = "Game Over", message = "Player 4 had win!!")
    #        root.destroy
